...
data['student_status'] = data['student_status'].replace('Evet',True).replace('Hayır',False)     #define data types
...
#Selecting 5 best features and applying PCA with this features
k = 5
